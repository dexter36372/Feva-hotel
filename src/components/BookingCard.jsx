...
const BookingCard = ({ username }) => {
  return (
    <div
      ...
      style={{ backgroundImage: "url('https://iili.io/F6GMm8u.png')" }}
    >
      <motion.div
      ...
      >
        <div className="text-white mb-4 text-center font-bold text-xl uppercase tracking-wide">
        ...
        <motion.div
          ...
          className="mt-8 bg-white text-black p-4 rounded-xl shadow-inner border-2 border-black text-center text-2xl font-bold tracking-wide uppercase"
        >
